...
plot(NYC4$Bronx, resid(lrbronx.lm), xlab = "Confirmed Covid Cases", ylab = "Residuals", main = "Scatterplot of Confirmed Covid Cases in Bronx Cleaned Data & Residuals")
...
plot(NYC4$`Brooklyn (Kings)`, resid(lrbrooklyn.lm), xlab = "Confirmed Covid Cases", ylab = "Residuals", main = "Scatterplot of Confirmed Covid Cases in Brooklyn Cleaned Data & Residuals")
...
plot(NYC4$`Manhattan (New York)`, resid(lrmanhattan.lm), xlab = "Confirmed Covid Cases", ylab = "Residuals", main = "Scatterplot of Confirmed Covid Cases in Manhattan Cleaned Data & Residuals")
...
plot(NYC4$Queens, resid(lrqueens.lm), xlab = "Confirmed Covid Cases", ylab = "Residuals", main = "Scatterplot of Confirmed Covid Cases in Queens Cleaned Data & Residuals")
...
plot(NYC4$`Staten Island (Richmond)`, resid(lrstatenisland.lm), xlab = "Confirmed Covid Cases", ylab = "Residuals", main = "Scatterplot of Confirmed Covid Cases in Staten Island Cleaned Data & Residuals")
